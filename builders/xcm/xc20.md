...
Although XC-20s and ERC-20s are very similar, there are some distinct differences to be aware of. First and foremost, XC-20s are Substrate-based assets and ERC-20s are Ethereum-based assets.

Since XC-20s can be interacted with through an ERC-20 interface, they have the additional benefit of being accessible from Substrate and Ethereum. This ultimately provides greater flexibility when working with these types of assets. You can interact with them using the Substrate assets pallet or the ERC-20 interface.

As XC-20s are Substrate-based, they are also subject to be directly impacted by Substrate features such as governance.
