...
|    `moonChainFee`    |                                                                     the [asset](#assets) and amount that is needed to pay for Moonbeam's XCM fees. If different from the `asset` to be transferred, the fee will be sent in this asset in addition to the `asset` to be transferred                                                                     |
