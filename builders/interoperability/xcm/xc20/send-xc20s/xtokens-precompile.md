...
description: Learn how to send XC-20s to other chains using the X-Tokens Precompile, which enables you to send XC-20s cross-chain using Ethereum libraries like Ethers and Web3.
---
