...
Moonbeam does not use checkpoint blocks and instead relies on the GRANDPA finality gadget, where the finality process is completed in parallel to block production.
