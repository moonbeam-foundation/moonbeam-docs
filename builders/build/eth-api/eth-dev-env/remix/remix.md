...
![Local Moonbeam node producing blocks](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-1.png)
...
![MetaMask installation with a balance](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-2.png)
...
![File explorer](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-3.png)
...
![Create a new file for your Solidity contract](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-4.png)
...
![Paste the contract into the editor](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-5.png)

Now, navigate to the compile sidebar option to press the “Compile MyToken.sol” button:

![Compile MyToken.sol](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-6.png)
...
![Replace](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-7.png)
...
![Enter an account balance and deploy](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-8.png)

You will be prompted in MetaMask to confirm the contract deployment transaction.

![Confirm the transaction message](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-9.png)
...
![Confirmed label on a transaction](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-10.png)
...
![Interact with the contract from Remix](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-11.png)
...
![Add a token](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-12.png)
...
![Paste the copied contract address](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-13.png)
...
![Add the tokens to your MetaMask account](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-14.png)
...
![Confirmation of the token transfer](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-15.png)
...
![Verify the reduction in account balance](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-16.png)
...
![Activating the Moonbeam Remix Plugin](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-17.png)
...
![Compiling and Deploying a Contract with the Moonbeam Remix Plug](/images/builders/build/eth-api/eth-dev-env/remix/remix/using-remix-18.png)
