...
This is particularly useful for interacting with Moonbeam's [Ethereum JSON-RPC](/builders/pallets-precompiles/eth-rpc/){target=\_blank} endpoints or Moonbeam's [custom RPC](/builders/pallets-precompiles/moonbeam-custom-api/){target=\_blank} endpoints.
