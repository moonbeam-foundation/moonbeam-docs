...
-  Upgrades to the event subscription support, adding the possibility of using wildcards and conditional formatting for topics. You can find more information [here](http://docs.moonbeam.network/getting-started/testnet/pubsub/#using-wildcards-and-conditional-formatting). ![v3](/images/testnet/v3.svg)
