Tokens on Moonbase Alpha, named DEV, will be issued freely on demand. The DEV token does not hold any value. Currently, there are two ways you can get access to this token: through a Discord bot, or manually.
