...
2. Use `wget` to grab the latest [release binary](https://github.com/moonbeam-foundation/moonbeam/releases){target=\_blank} and output it to the directory created in the previous step
    ...
    === "Moonbeam"
        ...
        ```bash
        wget https://github.com/moonbeam-foundation/moonbeam/releases/download/v{{ networks.moonbeam.parachain_release_tag }}/moonbeam \
    ...
    === "Moonriver"
        ...
        ```bash
        wget https://github.com/moonbeam-foundation/moonbeam/releases/download/v{{ networks.moonriver.parachain_release_tag }}/moonbeam \
    ...
    === "Moonbase Alpha"
        ...
        ```bash
        wget https://github.com/moonbeam-foundation/moonbeam/releases/download/v{{ networks.moonbase.parachain_release_tag }}/moonbeam \
