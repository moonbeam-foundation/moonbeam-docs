...
export function App() {
    ...
    const ABI = [{"inputs":[],"name":"increment","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"number","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"timestamp","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}];
    ...
    useEffect(() => {
        async function fetchContractAndData() {
            try {
                ...
                console.log("Data fetched:", { num: num.toString(), time: time.toString() });

                setNumber(num.toString());
                setTimestamp(time ? new Date(Number(time) * 1000).toLocaleString() : "No timestamp yet");
            } catch (error) {
