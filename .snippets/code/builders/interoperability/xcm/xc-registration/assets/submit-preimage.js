...
async function submitPreimage() {
    ...
    const encodedCallData = '0x0100083800ffffffffffffffffffffffffffffffff010100e10d121478634d4641404d7920466f726569676e2041737365743a00010100e10d88130000000000000000000000000000';
    ...
    try {
        ...
        const txHash = await new Promise((resolve, reject) => {
            preimageCall.signAndSend(account, { nonce }, ({ status, dispatchError, events }) => {
                if (dispatchError) {
