...
// This script calculates the transaction fees of all transactions in a
// block according to the transaction type (for Ethereum API: legacy,
// EIP-1559 or EIP-2930 standards, and Substrate API) using a static base
// fee. It also calculates the total fees in the block.

// Define static base fee per network
const baseFee = {
  moonbeam: 100000000000n,
  moonriver: 1000000000n, // Prior to runtime 2200
  moonbase: 1000000000n, // Prior to runtime 2100
};
