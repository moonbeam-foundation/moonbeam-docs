...
To submit your project to the Moonbeam DApp Directory, you'll need to have the **Project** handy, which in this case is `My Project`.
...
| <div style="width:145px">Property</div> |                         Type                          |                                                                                                                                                                      Description                                                                                                                                                                       |
|:---------------------------------------:|:-----------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
...
| `mimeType` | String |         The standard MIME type of the file. E.g., `"image/jpeg"`         |
