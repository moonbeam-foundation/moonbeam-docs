...
![Banner Image](/images/tutorials/truffle-start-to-end/truffle-banner.png)
...
![Run Truffle compile](/images/tutorials/truffle-start-to-end/truffle-1.png)
...
![Install and spin up a Moonbeam development node](/images/tutorials/truffle-start-to-end/truffle-2.png)
...
![Daizy NFT metadata and image](/images/tutorials/truffle-start-to-end/truffle-3.png)
...
![Run first test](/images/tutorials/truffle-start-to-end/truffle-4.png)
...
![Run first two tests](/images/tutorials/truffle-start-to-end/truffle-5.png)
...
![Run all tests](/images/tutorials/truffle-start-to-end/truffle-6.png)
...
![Stop the development node](/images/tutorials/truffle-start-to-end/truffle-7.png)
...
![Run all tests on Moonbase Alpha](/images/tutorials/truffle-start-to-end/truffle-8.png)
...
![Deploy contracts on Moonbase Alpha](/images/tutorials/truffle-start-to-end/truffle-9.png)
...
![Verify contracts on Moonbase Alpha](/images/tutorials/truffle-start-to-end/truffle-10.png)
...
![Deploy contracts on Moonbeam](/images/tutorials/truffle-start-to-end/truffle-11.png)
...
![Deploy contracts on Moonbeam](/images/tutorials/truffle-start-to-end/truffle-12.png)
