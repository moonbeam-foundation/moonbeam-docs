...
To work with these interfaces, you must install the [Ethereum library](/builders/ethereum/libraries/){target=\_blank} of your choice. For this example, we'll use [Ethers.js](/builders/ethereum/libraries/ethersjs/){target=\_blank}.
...
With the contract created, you must next deploy the contract. Since we've already installed Ethers.js, let's use it to deploy the contract. If you're unfamiliar with the process, you can reference the [Ethers.js docs on deploying a smart contract](/builders/ethereum/libraries/ethersjs/#deploy-a-contract){target=\_blank}.
